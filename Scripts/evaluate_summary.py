...
def review_summary_with_mistral(email_text, attachments_as_text, email_category, summary):
    prompt = f"""
...
review_result = review_summary_with_mistral(email_text, attachments_as_text, email_category, summary)
print(review_result)
