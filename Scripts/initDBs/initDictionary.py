...
def main():
    ...
    dictionary_db = Chroma(persist_directory="Dictionary_DB", embedding_function=get_embedding_function())
    # dictionary_results = dictionary_db.similarity_search("cto", k=5)
    #for idx, result in enumerate(results):
    # print(f"Result {idx+1}: {result.page_content}")
    results_with_scores = dictionary_db.similarity_search_with_score("MBL ", k=5)
